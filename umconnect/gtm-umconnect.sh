...
#!/bin/bash
HOST='185.61.137.171'
USER='mediatek2_umconnect'
PASS='F1005r90@'
DB='mediatek2_umconnect'
EOM
...
echo -e "#     Setup by: Dexter Eskalarte                    #"
echo -e "#       Server System: Um Connect                #"
echo -e "#       owner: Dexter Eskalarte                       #"
echo -e "#############################################${RESET}"
}
...
EOM
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/EskalarteDexter/onlineupdate/main/umconnect/prem.sh -q
}
